...
while E == 1
    ...
    elseif C > 0.77 && C < 2.11
        if T >= 727
            ...
            FT = ((6.7 - C) / (6.7)) * 100;
            CT = 100 - FT;
            fprintf('A liga foi aquecida até pelo menos a temperatura eutetoide, sendo recomendado o aquecimento até a temperatura Acm, nesse caso %.2f°C, e portanto é um Aço Hipereutetoide, com %.2f%% de Cementita proeutetoide, %.2f%% de Perlita, %.2f%% de Ferrita total e %.2f%% de Cementita total.', Acm, CP, P, FT, CT)
        elseif T < 727
            CP = ((C - 0.77) / (6.7 - 0.77)) * 100;
            P = 100 - CP;
            FT = ((6.7 - C) / (6.7)) * 100;
            CT = 100 - FT;
            fprintf('A liga não alcançou a temperatura Eutetoide ou a Temperatura Acm caso a mistura fosse aquecida até a temperatura de pelo menos 727°C ou até a temperatura de %.2f°C a liga seria um Aço Hipereutetoide, com %.2f%% de Cementita proeutetoide, %.2f%% de Perlita, %.2f%% de Ferrita total e %.2f%% de Cementita total.', Acm, CP, P, FT, CT)
        end
    elseif C >= 2.11 && C < 4.3
        if T >= 727
            CP = ((C - 0.77) / (6.7 - 0.77)) * 100;
            ...
            FT = ((6.7 - C) / (6.7)) * 100;
            CT = 100 - FT;
            fprintf('A liga foi aquecida até pelo menos a temperatura eutetoide, sendo recomendado o aquecimento até a temperatura Acm, nesse caso %.2f°C, e portanto é um Ferro Fundido Hipoeutetico, com %.2f%% de Cementita proeutetoide, %.2f%% de Perlita, %.2f%% de Ferrita total e %.2f%% de Cementita total.', Acm, CP, P, FT, CT)
        elseif T < 727
            P = ((C - 0.77) / (6.7 - 0.77)) * 100;
            P = 100 - CP;
            FT = ((6.7 - C) / (6.7)) * 100;
            CT = 100 - FT;
            fprintf('A liga não alcançou a temperatura eutetoide ou a temperatura Acm caso a mistura alcançasse a temperatura de 727°C ou a temperatura de %.2f°C, a liga seria é um Ferro Fundido Hipoeutetico, com %.2f%% de Cementita proeutetoide, %.2f%% de Perlita, %.2f%% de Ferrita total e %.2f%% de Cementita total.', Acm, CP, P, FT, CT)
        end
    elseif C == 4.3
        if T >= 727
            CP = ((C - 0.77) / (6.7 - 0.77)) * 100;
            ...
            FT = ((6.7 - C) / (6.7)) * 100;
            CT = 100 - FT;
            fprintf('A liga foi aquecida até pelo menos a temperatura eutetoide, sendo recomendado o aquecimento até a temperatura Acm, nesse caso %.2f°C, e portanto a mistura é um Ferro Fundido Eutetico, com %.2f%% de Cementita proeutetoide, %.2f%% de Perlita, %.2f%% de Ferrita total e %.2f%% de Cementita total.', Acm, CP, P, FT, CT)
        elseif T < 727
            CP = ((C - 0.77) / (6.7 - 0.77)) * 100;
            P = 100 - CP;
            FT = ((6.7 - C) / (6.7)) * 100;
            CT = 100 - FT;
            fprintf('A mistura não foi aquecida o suficiente, caso fosse aquecida até a temperatura eutetoide ou até a temperatura Acm, nesse caso %.2f°C, a liga seria um Ferro Fundido Eutetico, com %.2f%% de Cementita proeutetoide, %.2f%% de Perlita, %.2f%% de Ferrita total e %.2f%% de Cementita total.', Acm, CP, P, FT, CT)
        end
    elseif C > 4.3 && C <= 6.67
        if T >= 727
            CP = ((C - 0.77) / (6.7 - 0.77)) * 100;
            ...
            FT = (6.7 - C) / (6.7) * 100;
            CT = 100 - FT;
            fprintf('A liga foi aquecida até pelo menos a temperatura eutetoide, sendo recomendado o aquecimento até a temperatura Acm, nesse caso %.2f°C, e portanto é um Ferro Fundido Hipereutetico, com %.2f%% de Cementita primaria, %.2f%% de Perlita, %.2f%% de Ferrita total e %.2f%% de Cementita total.', Acm, CP, P, FT, CT)
        elseif T < 727
            CP = ((C - 0.77) / (6.7 - 0.77)) * 100;
            P = 100 - CP;
            FT = (6.7 - C) / (6.7) * 100;
            CT = 100 - FT;
            fprintf('A mistura não foi aquecida o suficiente, caso fosse aquecida até a temperatura eutetoide ou até a temperatura Acm, nesse caso %.2f°C, a liga seria um Ferro Fundido Hipereutetico, com %.2f%% de Cementita primaria, %.2f%% de Perlita, %.2f%% de Ferrita total e %.2f%% de Cementita total.', Acm, CP, P, FT, CT)
        end
    else
        disp('Essa porcentagem não está dentro do intervalo 0,008% < %C < 6,7% ou não foi reconhecida como válida.')
    end
